                  ...
                  <div>
                    <span className="relative w-full">
                      ...
                      <img
                        ...
                        alt="eye"
                        className="absolute top-1/2 right-5 xl_mobile:right-7 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer"
                        onClick={() => setEye(!eye)}
                      />
                    </span>
              ...
              {onSubmitMessage && (
                <div className="w-full rounded-md bg-[#00CF91] bg-opacity-20 flex items-center justify-center gap-3 py-3 mt-10">
                  <img
                    src={check}
                    alt="tick"
                    className="w-5 lg_mobile:w-8 border border-[#00F4AA] rounded-full pointer-events-none"
                  />
                  <p className="text-center text-[#07946A] text-[0.6rem] lg_mobile:text-sm sm_tablet:text-base font-medium">
                    {onSubmitMessage}
                  </p>
                </div>
              )}
        ...
        >
          <div className="flex flex-col items-center justify-center gap-5 px-20">
            ...
            <span className="w-full flex flex-col gap-2 text-4xl font-bold">
              <h2 className="text-[#0D0B01] text-center">
                Every step that you need
              </h2>
              <h2 className="text-[#00CF91] text-center">in one place!</h2>
            </span>
            <p className="w-full text-lg font-medium text-[#73778B] text-center">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. explre
              anduering. consectetur adipiscing elit.
            </p>
          </div>
        </section>
      </section>
