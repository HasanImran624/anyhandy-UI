...
export const InteriorPaintingJobForm = ({ setSelectedSubPaintingJob }) => {
  ...
  const addToList = useCallback(() => {
    const altreadyAdded = !!formAttributes.subServices.find(
      (s) => s.code === PaintingJobCode.INTERIOR
    );
    ...
    setFormAttributes({
      ...
      subServices: [
        ...
        {
          ...selectedAttributes,
          code: PaintingJobCode.INTERIOR,
          name: PaintingJobNames.INTERIOR,
        },
      ],
    });
