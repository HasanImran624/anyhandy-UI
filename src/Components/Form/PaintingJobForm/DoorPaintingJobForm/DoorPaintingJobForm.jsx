...
export const DoorPaintingJobForm = ({ setSelectedSubPaintingJob }) => {
  ...
  const addToList = useCallback(() => {
    ...
    setFormAttributes({
      ...
      subServices: [
        ...
        {
          ...selectedAttributes,
          code: PaintingJobCode.DOOR,
          name: PaintingJobNames.DOOR,
        },
      ],
    });
            ...
            return (
              <span
                ...
                className={`flex flex-1 items-center justify-center gap-2 p-3 border rounded-lg cursor-pointer ${
                  selectedAttributes.doors === room.room &&
