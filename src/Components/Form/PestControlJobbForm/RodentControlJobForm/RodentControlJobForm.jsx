...
export const RodentControlJobForm = ({ setSelectedSubPestControlJob }) => {
  ...
  const addToList = useCallback(() => {
    const altreadyAdded = !!formAttributes.subServices.find(
      (s) => s.code === PestControlJobCode.RODENT
    );
    ...
    setFormAttributes({
      ...
      subServices: [
        ...
        {
          ...selectedAttributes,
          code: PestControlJobCode.RODENT,
          name: PestControlJobNames.RODENT,
        },
      ],
    });
