          ...
          <section className='w-full sm_desktop:w-[50%] bg-white h-screen overflow-y-scroll sm_desktop:h-fit sm_desktop:max-h-[90vh] p-5 sm_tablet:p-10 flex flex-col gap-10 font-Onest rounded-[30px] relative z-30 popup'>
            <div className='flex justify-center gap-2 flex-col'>
              <span className='flex items-center justify-between'>
                <h2 className='text-[#292C38] text-4xl font-bold'>Interior Home Painting</h2>
              ...
              <div className="flex flex-col gap-1">
                <span className="flex items-center justify-between bg-transparent hover:shadow-lg hover:bg-white p-4 rounded-xl transition-all ease-in-out duration-200">
                  ...
                  <span className="flex gap-3 items-center">
                    <LuPen size={20} color="#96A0B5" className="cursor-pointer" onClick={() => setEditSubService(true)} />
