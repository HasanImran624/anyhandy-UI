    ...
    <>
      <div className="package-container gap-5 sm_desktop:gap-10">
        ...
        <div className="detail-text-group">
          <p className="detail-text sm_desktop:w-fit">
            Lorem ipsum dolor sit amet consectetur. Proin donec pulvinar
            malesuada consequat purus integer congue. Pulvinar tincidunt
            consequat purus integer congue.
          </p>
            ...
            return (
              ...
              >
                <Filter
                  name={filter.name}
                  backgroundColor={
                    selectedFilter === filter.id ? "#00CF91" : "#FFFF"
                  }
